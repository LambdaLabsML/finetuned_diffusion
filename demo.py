...
if is_colab:
    pipe = StableDiffusionPipeline.from_pretrained(
        ...
        scheduler=DPMSolverMultistepScheduler.from_pretrained(
            current_model.path, subfolder="scheduler"
        ),
...
with gr.Blocks(css="style.css") as demo:
    ...
    ex = gr.Examples(
        [
            [
                models[7].name,
                "tiny cute and adorable kitten adventurer dressed in a warm overcoat with survival gear on a winters day",
                7.5,
                25,
            ],
            ...
            [
                models[6].name,
                "Aloy from Horizon: Zero Dawn, half body portrait, smooth, detailed armor, beautiful face, illustration",
                7.0,
                30,
            ],
